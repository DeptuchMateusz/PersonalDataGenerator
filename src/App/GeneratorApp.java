...
public class GeneratorApp {
    ...
    public GeneratorApp() {
        ...
        button.addActionListener(e -> {
            ...
            try {
                ...
                Gender gender = getSelectedGender(Objects.requireNonNull(genderDropdown.getSelectedItem()).toString());
                if (numPeople < 0) {
    ...
    private Gender getSelectedGender(String selectedItem) {
        return switch (selectedItem) {
            case "Only Male" -> Gender.MALE;
            case "Only Female" -> Gender.FEMALE;
            default -> null; // Both or unknown option
        };
    }
